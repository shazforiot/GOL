        ...
        <table class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
            ...
            <tr valign="top">
                ...
                <xsl:variable name="allFailureCount"
                              select="count(/testResults/sampleResult[attribute::success='false'])"/>
                <xsl:variable name="allSuccessCount"
                              select="count(/testResults/sampleResult[attribute::success='true'])"/>
        ...
        <table class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
            ...
            <xsl:for-each select="/testResults/sampleResult[not(@label = preceding::*/@label)]">
                ...
                <xsl:variable name="failureCount"
                              select="count(../sampleResult[@label = current()/@label][attribute::success='false'])"/>
                <xsl:variable name="successCount"
                              select="count(../sampleResult[@label = current()/@label][attribute::success='true'])"/>
                            ...
                            <table bordercolor="#000000" border="1" cellpadding="0" cellspacing="0" width="95%">
                                ...
                                <xsl:for-each select="../sampleResult[@label = $label and @threadName != $label]">
                                    <tr>
                                        ...
                                        <td><xsl:value-of select="@time"/>ms
                                        </td>
                                        <td>
            ...
            <xsl:for-each select="/testResults/sampleResult[not(@label = preceding::*/@label)]">
                ...
                <xsl:if test="$failureCount > 0">
                    ...
                    <table class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
                        ...
                        <xsl:for-each
                                select="/testResults/sampleResult[@label = current()/@label][attribute::success='false']">
                            <tr>
                                <td>
